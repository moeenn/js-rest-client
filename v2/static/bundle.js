...
main();
},{"./eventManager.js":1,"./views/detailsWindow":3,"./views/responseWindow":4,"axios":5}],3:[function(require,module,exports){
class DetailsWindow {
  constructor(props) {
    this.state = props;
  }
      ...
      <div>
        <table>
          <tbody>
            ...
            <tr>
              <td>Response Time</td>
              <td>${this.state.responseTime} ms</td>
            </tr>
          </tbody>
        </table>
      </div>
...
class ResponseWindow {
  ...
  render() {
    return (`
      <code>
        <pre>${this.state.jsonstring}</pre>
      </code>    
    `);
  }
}

module.exports = ResponseWindow; 
